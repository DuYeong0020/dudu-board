...
//        response1.getCommentId() = 165097343407206400
//        response2.getPath() = 0000300000
//        response2.getCommentId() = 165097343658864640Q
//        response3.getPath() = 000030000000000
//        response3.getCommentId() = 165097343700807680
    }
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v2/comments/{commentId}", 165097343658864640L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    @Test
    void countTest() {
        CommentResponse commentResponse = create(new CommentCreateRequestV2(2L, "my content2", null, 1L));
